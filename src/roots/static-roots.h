...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kUncompiledDataWithoutPreparseDataMap = 0x164d;
  static constexpr Tagged_t kUncompiledDataWithPreparseDataMap = 0x1675;
  static constexpr Tagged_t kUncompiledDataWithoutPreparseDataWithJobMap =
      0x169d;
  static constexpr Tagged_t kUncompiledDataWithPreparseDataAndJobMap = 0x16c5;
  static constexpr Tagged_t kOnHeapBasicBlockProfilerDataMap = 0x16ed;
  static constexpr Tagged_t kTurbofanBitsetTypeMap = 0x1715;
  static constexpr Tagged_t kTurbofanUnionTypeMap = 0x173d;
  static constexpr Tagged_t kTurbofanRangeTypeMap = 0x1765;
  static constexpr Tagged_t kTurbofanHeapConstantTypeMap = 0x178d;
  static constexpr Tagged_t kTurbofanOtherNumberConstantTypeMap = 0x17b5;
  static constexpr Tagged_t kTurboshaftWord32TypeMap = 0x17dd;
  static constexpr Tagged_t kTurboshaftWord32RangeTypeMap = 0x1805;
  static constexpr Tagged_t kTurboshaftWord64TypeMap = 0x182d;
  static constexpr Tagged_t kTurboshaftWord64RangeTypeMap = 0x1855;
  static constexpr Tagged_t kTurboshaftFloat64TypeMap = 0x187d;
  static constexpr Tagged_t kTurboshaftFloat64RangeTypeMap = 0x18a5;
  static constexpr Tagged_t kInternalClassMap = 0x18cd;
  static constexpr Tagged_t kSmiPairMap = 0x18f5;
  static constexpr Tagged_t kSmiBoxMap = 0x191d;
  static constexpr Tagged_t kExportedSubClassBaseMap = 0x1945;
  static constexpr Tagged_t kExportedSubClassMap = 0x196d;
  static constexpr Tagged_t kAbstractInternalClassSubclass1Map = 0x1995;
  static constexpr Tagged_t kAbstractInternalClassSubclass2Map = 0x19bd;
  static constexpr Tagged_t kExportedSubClass2Map = 0x19e5;
  static constexpr Tagged_t kSortStateMap = 0x1a0d;
  static constexpr Tagged_t kWasmFastApiCallDataMap = 0x1a35;
